...
import de.syss.MifareClassicTool.Bill_Activity;
...
public class MainMenu extends AppCompatActivity {
    ...
    LinearLayout llIpadress,llMainPage;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Utils.blackIconStatusBar( MainMenu.this, R.color.random);
    ...
    void  init(){
        ...
        llIpadress=findViewById(R.id.llIpadress);
        llMainPage=findViewById(R.id.llMainPage);
        tvClickIP=findViewById(R.id.tvClickIP);
    ...
    public void onShowReadTag(View view) {
        Intent intent = new Intent(this, Select_Location_Activity.class);
        startActivity(intent);
    }
