...
ImageView imgAdd, imgMinus;
    ...
    public Adapter_Order(Context context, List<Product> liveList,RelativeLayout rlClearList) {
        //List<SiderImageModel> slider_image_list
        this.context = context;
        this.liveList = liveList;
        this.rlClearList = rlClearList;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        rlClearList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                // Optionally, notify any listeners about the data change
