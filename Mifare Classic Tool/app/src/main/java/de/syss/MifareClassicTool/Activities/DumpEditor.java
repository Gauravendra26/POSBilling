...
public class DumpEditor extends BasicActivity
    ...
    String memberID;
    String serialno, MAINID, name, counponno, amount = "1";
    TextView tvId, tvName, tvCardAmount, tvCardHolderName;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rlContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Select_Location_Activity.class);
    ...
    public void cardData(String uservalue) {
        ...
        if (connect != null) {
            ...
            try {
                ...
                String query = "SELECT serialno, MAINID, name, memberID " +
                ...
                while (rs.next()) {
                    ...
                    if (serialno != null && MAINID != null && name != null && memberID != null) {
                        ...
                        Log.e("ValueOFMenuModel", "Data found: " + serialno + " " + MAINID + " " + name + " " + memberID);
                    } else {
            ...
            try {
                ...
                if (!rs.next()) {
                    ...
                    do {
                        ...
                        if (counponno != null && amount != null) {
                            Log.e("ValueOFAmount", "Data found: " + counponno + " " + amount);
